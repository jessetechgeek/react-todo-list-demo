...
const TodoListPage = () => {
    ...
    const toggleItemCompletion = async (item: TodoItem) => {
        ...
        try {
            ...
            console.log("Current completed state:", item.completed);
            console.log("New completed state:", !item.completed);
            ...
            console.log("API response for updated item:", updatedItem);
        ...
        <div className="max-w-6xl mx-auto px-4 py-8">
            ...
            <div className="bg-white rounded-lg shadow p-6 mb-8">
                ...
                <form onSubmit={handleCreateItem}>
                    ...
                    <div className="mb-4">
                        <label htmlFor="itemDescription" className="block text-gray-700 mb-2">Description
                            (optional)</label>
                        <textarea
                            id="itemDescription"
                            className="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                            <label htmlFor="itemDueDate" className="block text-gray-700 mb-2">Due Date
                                (optional)</label>
                            <input
                                id="itemDueDate"
                                type="date"
